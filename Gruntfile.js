		...
		*/
		grunt.initConfig({
			...
			uglify: {
				...
				build: {
					files:  {},
					src:    'multiselect-checklist.js',
					dest:   'multiselect-checklist.min.js'
				}
			},
			less: {
				development: {
					...
					files: {
						"main.css": "_base.less",
						"multiselect-checklist.css": "_multiselect-checklist.less"
					}
				}
			},
			cssmin: {
				dev: {
					src: ['multiselect-checklist.css'],
					dest: 'multiselect-checklist.min.css'
				}
			}/*,
			karma: {
				unit: {
